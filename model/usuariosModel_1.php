...
/*	OJO ESTA FUNCION ESTA PERFECTA SOLO QUE ES LA VERSION ANTES DE SETEARLE LA ACTIVACION POR EMAIL 
PARA EL USUARIO QUE ACABA DE REGISTRARSE
	...
	public function add_usuario()
	{
		...
		if(empty($_FILES["foto"]["name"]))
		{
			...
			if($PDOsoporte2->fetchColumn() == 0)
			{
				...
				self::set_names_UTF8();	
				$sqlconsulta = "insert into usuarios values (null, ?, ?, ?, ?, ?, ?, 0)";
